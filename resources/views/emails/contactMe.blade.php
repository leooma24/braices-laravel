...
<head>
    ...
    <title>Me interesa tu propiedad</title>
    <style>
        body {
                ...
                <table class="email-content">
                    ...
                    <tr>
                        <td class="email-header text-center" style="text-align: center;" center>
                            ...
                            <h2>Me interesa tu propiedad</h2>
                        </td>
                    </tr>
                    <!-- Body -->
                    <tr>
                        <td class="email-body">
                            ...
                            <strong style="width: 150px;">Propiedad:</strong> {{ $data['property']->title }} <a href="{{ route('property', $data['property']->slug)}}">Ver</a>  <br />
                            <strong style="width: 150px;">Teléfono:</strong> {{ $data['phone_number'] }}<br />
