...
class PropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'square_meters_contruction' => 'required|numeric',
    ...
    public function attributes()
    {
        return [
            ...
            'bedrooms' => 'Recámaras',
            'bathrooms' => 'Baños',
            'square_feet' => 'Metros cuadrados (terreno)',
            'square_meters_contruction' => 'Metros cuadrados de construcción',
            'levels' => 'Niveles',
            'lot_size' => 'Tamaño del lote',
            'front' => 'Metros de frente',
            'depth' => 'Metros de fondo',
            ...
            'property_status_id' => 'Estatus de la propiedad',
        ];
    }
}
